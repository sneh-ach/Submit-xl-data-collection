...
if __name__ == '__main__':
    ...
    while not rospy.is_shutdown():
        ...
        bag = rosbag.Bag('/media/sneh/Heracleia/Robot_Data/Indoor_Data/Data-' + day+'-Time-' + time + '.bag', 'w')
        ...
        ts = message_filters.ApproximateTimeSynchronizer([img_sub, joint_sub, laser_sub, cloud_sub], 10, 1, allow_headerless=False)
