...
def callback(image, joints, laser):
    global bag
...
if __name__ == '__main__':
    ...
    while not rospy.is_shutdown():
        ...
        bag = rosbag.Bag('/media/sneh/Heracleia/Robot_Data/Outdoor_Data/Data-' + day+'-Time-' + time + '.bag', 'w')
        ...
        laser_sub = message_filters.Subscriber('/robot/front_laser/filtered_scan', LaserScan)

        ts = message_filters.ApproximateTimeSynchronizer([img_sub, joint_sub, laser_sub], 10, 1, allow_headerless=False)
